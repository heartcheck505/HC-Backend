...
var startupLogger = startupLoggerFactory.CreateLogger("HeartCheck.Program");
...
try
{
        ...
        jwtSettings.SecretKey.Length < 32)
    {
        ...
        startupLogger.LogWarning(
            "La configuración 'Jwt:SecretKey' es inválida o usa el valor de ejemplo por defecto. " +
            "Se generó una clave aleatoria en memoria: los tokens emitidos se invalidarán en cada " +
            "reinicio del proceso y todas las sesiones existentes caducarán. Configúrala mediante " +
...
catch (Exception ex)
{
    Console.Error.WriteLine(
        "[HeartCheck] Fallo fatal al inicializar la aplicación: " + ex);
    throw;
}
